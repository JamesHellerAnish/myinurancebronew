...
var policyData = {
  ...
  /* ── Insurer logos ──────────────────────────────────────────
     ...
     ──────────────────────────────────────────────────────────── */
  brands: {
    'Axis Max Life':         { logo: 'axismax.png',      accent: '#143A72', initials: 'AM' },
    'Max Life':              { logo: 'axismax.png',      accent: '#143A72', initials: 'ML' },
    'HDFC Life':             { logo: 'hdfclife.png',     accent: '#E2101A', initials: 'HL' },
    'HDFC ERGO':             { logo: 'hdfcergo.png',     accent: '#D91923', initials: 'HE' },
    'ICICI Prudential':      { logo: 'icicipru.png',     accent: '#F58220', initials: 'IP' },
    'ICICI Lombard':         { logo: 'icicilombard.png', accent: '#B45309', initials: 'IL' },
    'Bajaj Life':            { logo: 'bajajlife.png',    accent: '#005EAC', initials: 'BL' },
    'Bajaj General':         { logo: 'bajajgeneral.png', accent: '#0E7490', initials: 'BG' },
    'SBI Life':              { logo: 'sbilife.png',      accent: '#1E3A8A', initials: 'SL' },
    'SBI General':           { logo: 'sbigeneral.png',   accent: '#0094D9', initials: 'SG' },
    'Aditya Birla Sun Life': { logo: 'absl.png',         accent: '#C7222A', initials: 'AB' },
    'Aditya Birla Health':   { logo: 'abhi.png',         accent: '#C7222A', initials: 'AB' },
    'Care Health':           { logo: 'care.png',         accent: '#FFE000', initials: 'CH' },
    'Niva Bupa':             { logo: 'nivabupa.png',     accent: '#00AEEF', initials: 'NB' },
      ...
      plans: [
        {
          ...
          entryAge: '18–65 yrs',
          coverRange: '₹25 L – no maximum limit (subject to underwriting)',
          tenure: 'To age 85 / whole life',
          criticalIllness: 'Rider — 64 illnesses on the Platinum variant, up to 30 yrs',
          premiumBreak: true,
          ...
          features: [
            ...
            'Critical illness rider covering 64 illnesses on its Platinum variant, for terms up to 30 years',
        ...
        },
        {
          ...
          entryAge: '18–65 yrs',
          coverRange: '₹50 L – unlimited (subject to underwriting)',
          tenure: 'To age 85',
      ...
      plans: [
        {
          ...
          entryAge: '18 yrs and above — no maximum entry age',
          coverRange: '₹10 L – ₹2 Cr',
          tenure: '1–5 years',
          restoration: 'Unlimited, built in',
          bonus: 'Infinite Benefit — 100% of base cover added every year, no cap',
          ...
          features: [
            ...
            'Infinite Benefit adds 100% of the base cover every year with no upper limit and regardless of claims',
          ...
          pros: [
            ...
            'Cover compounds every year through Infinite Benefit, so a ₹10 lakh policy is worth far more by year five',
        ...
        },
        {
          ...
          waiting: { ped: 2, specific: 1, maternity: 'Covered on Platinum Infinite — waiting period 48 months (single adult) / 24 months (other family combinations), cover up to ₹2 Lac' },
