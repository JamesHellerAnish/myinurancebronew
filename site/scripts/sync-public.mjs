...
const FILES = [
  ...
  // /favicon.ico is a fixed path browsers and crawlers request whether or not the HTML
  // declares an icon, so it has to sit at the build root rather than under assets/.
  // Generated by make-logo-sizes.mjs from the same master as every other size.
  'favicon.ico',
